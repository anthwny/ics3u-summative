...
<template>
    <div class="topnav">
        <RouterLink v-if="currentUserEmail === ''" to="/"><img id="logo" src="../assets/better netflix.png"></RouterLink>
        <RouterLink v-if="currentUserEmail != ''" to="/movies"><img id="logo" src="../assets/better netflix.png"></RouterLink>
